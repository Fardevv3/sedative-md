...
const { WAMetric } = require('@adiwajshing/baileys/lib/WABinary/Legacy/Constants')
...
exports.generateProfilePicture = async (buffer) => {
    ...
    return {
        img: await cropped.scaleToFit(512, 512).getBufferAsync(jimp_1.MIME_JPEG),
        preview: await cropped.resize(512, 512).getBufferAsync(jimp_1.MIME_JPEG)
    };
};
